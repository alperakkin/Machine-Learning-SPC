...
class ConfigPanel(FloatLayout):
    ...
    def edit_parameter(self,state,i):
        print ("aktif düğme",state)
    ...
    def init(self):
        ...
        for i in range(button_count):
           ...
           self.children[i].size_hint = 1/button_count, 0.05
           self.children[i].pos = self.set_pos((1/button_count)*i, 0)
           self.children[i].source = "picture_lib/config_button"+str(i)+".png"
           self.children[i].bind(on_release=self.edit_parameter)
